...
ActiveRecord::Schema.define(version: 20150321081845) do
  ...
  create_table "imagemsgs", id: false, force: :cascade do |t|
    t.integer  "physician",          limit: 4
    ...
    t.integer  "imagemsgid",         limit: 4,   null: false
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
  end
  ...
  create_table "voicemsgs", force: :cascade do |t|
    t.integer  "physician",          limit: 4
    t.integer  "patient_id",         limit: 4
  ...
  create_table "voisemsgs", force: :cascade do |t|
    t.integer  "physician",          limit: 4
    t.integer  "patient_id",         limit: 4
    t.string   "voice_file_name",    limit: 255
    t.string   "voice_content_type", limit: 255
